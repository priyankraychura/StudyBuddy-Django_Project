...
// Checking on isAadmin box by clicking on label
const isAdminLabel = document.querySelector('.isAdmin_checkbox label');

isAdminLabel.addEventListener('click', () => {
  document.querySelector('.isAdmin_checkbox input').click();
});
